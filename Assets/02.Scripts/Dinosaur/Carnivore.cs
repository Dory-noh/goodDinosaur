...
public class Carnivore : Animal, ICarnivore
{
    ...
    public bool canTrace(IDinosaur other)
    {
        ...
        if (other is Raptor && this is Raptor)
        {
            ...
            if (gameObject.GetComponent<Raptor>().leader != null//== ((MonoBehaviour)other).GetComponent<Raptor>() 
    ...
    void TraceVictim()
    {
        ...
        if (closestVictim != null)
        {
            ...
            if((infoIdx == 0 && distanceToVictim > 4f) || (infoIdx == 1 && distanceToVictim > 8f) || (infoIdx == 2 && distanceToVictim > 15f))// 두 공룡의 위치가 매우 가까울 때 빙빙 도는 문제 막기 위함
    ...
    protected IDinosaur FindClosestVictim()
    {
